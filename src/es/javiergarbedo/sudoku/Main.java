...
public class Main extends javax.swing.JFrame {
    ...
    private void setLevel(int level) {
        ...
        if(level < TOP_LEVEL) {
            ...
            String fichero = "sudoku_levels.txt";
            RandomAccessFile raf;
            try {
                raf = new RandomAccessFile(fichero, "r");
                int tamLinea = raf.readLine().length();
                raf.seek(level*(tamLinea+1));
    ...
    private void initComponents() {
        ...
        java.util.ResourceBundle bundle = java.util.ResourceBundle.getBundle("res/strings_es"); // NOI18N
